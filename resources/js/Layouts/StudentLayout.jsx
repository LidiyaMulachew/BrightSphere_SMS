        ...
        <>
            ...
            <span className="hidden text-gray-400 lg:block">Student</span>
                ...
                <ul className="space-y-2 tracking-wide mt-8">
                    <li>
                        <a href="/student/dashboard" aria-label="dashboard" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-sky-500 hover:text-white">
                    ...
                    <li>
                        <a href={route('student.course.index')} className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-sky-500 hover:text-white">
                         
                            <span className="-mr-1 font-medium">Enroll In Courses</span>
                        </a>
                    </li>
                    
                    
                    <li>
                        <a href="/all-courses" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-sky-500 hover:text-white">
                         
                            <span className="-mr-1 font-medium">Courses</span>
                        </a>
                    </li>
                    <li>
                        <a href="/students/{studentId}/results"  className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-sky-500 hover:text-white">
