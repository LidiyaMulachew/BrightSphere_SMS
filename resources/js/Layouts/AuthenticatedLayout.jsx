        ...
        <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
            ...
            <span className="hidden text-gray-400 lg:block">Admin</span>
                ...
                <ul className="space-y-2 tracking-wide mt-8">
                    <li>
                        <a href='/super_admin/dashboard' aria-label="dashboard" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-sky-500 hover:text-white ">
                    ...
                    <li>
                        ...
                        <a href=  {route('users.index')} className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group  hover:bg-sky-500 hover:text-white">
                    ...
                    <li>
                        ...
                        <a href='/courses' className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group  hover:bg-sky-500 hover:text-white">
