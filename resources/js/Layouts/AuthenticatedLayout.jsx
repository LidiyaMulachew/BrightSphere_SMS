...
export default function Authenticated({ user, header, children }) {
    ...
    >
        ...
        User Account
                                    ...
                                    <Dropdown.Content>
                                        <Dropdown.Link href={route('students.index')}>Students</Dropdown.Link>
                                        <Dropdown.Link href={route('teachers.index')}>Teachers</Dropdown.Link>
                ...
                <li>
                    <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                        ...
                        <span className="group-hover:text-gray-700">Role</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
